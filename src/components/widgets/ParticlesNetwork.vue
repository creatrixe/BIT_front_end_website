<template>
    <div class='particle-network-animation' ref="particles_network"></div>
</template>
...
export default {
    ...
    props: {
        ...
        particles_color: {
            required: false,
            default: () => ["rgb(196,52,56)", "rgba(255,255,255,0.25)"]
        }
    },
    ...
    methods: {
        init() {
            ...
            var Particle = function(parent, x, y) {
                ...
                this.radius = getLimitedRandom(1.5, 9.5);
                this.opacity = 0;
            ...
            var ParticleNetwork = function(parent) {
                ...
                netLineDistance: 200,
                // netLineColor: "rgba(255,255,255,0.25)",
                netLineColor: $this.netline_color,
                particleColors:  $this.particles_color // ['#6D4E5C', '#aaa', '#FFC458' ]
                };
                this.canvas = parent.canvas;
                this.ctx = parent.ctx;
            ...
            pna.init($this.$refs.particles_network);
