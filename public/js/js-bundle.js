    ...
    ***************************************************************************** */
    ...
    var Da = function() {
        function t(e) {
            ! function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, t), this.app = e, e.browser = Object(l.a)(), e.mobile = e.browser.mobile || !!e.browser.os.match(/android/i), e.html.removeClass("no-js").addClass(e.mobile ? "mobile" : "desktop").addClass(e.browser.name), e.layout = e.view.find(".cb-layout"), e.ASSETS_PATH = "", e.mobile || h()(), this.app.scrollbar = new ra(e), this.app.loader = new ee(e), this.app.menu = new ha(e), this.app.navbar = new pa(e), this.app.cursor = new va(e), this.app.inputs = new Ca(e), this.app.checkboxes = new ba(e), this.app.modals = new la(e),
                function() {
            ...
            value: function() {
                return new Promise(function(t, e) {
                    ...
                    return n = this, i = this, !this.app.mobile && this.app.ctrl.scene && this.app.ctrl.scene.gl ? (this.scene = this.app.ctrl.scene, this.mouse = new ec(0, 0), this.mouseNorm = new ec(0, 0), this.currentIndex = 0, this.hovered = !1, this.textureUrl = this.item.map((function() {
                        let t = "".concat(i.app.ASSETS_PATH, "images/").concat(this.dataset.project, "").concat(window.devicePixelRatio > 1 ? "@2x" : "", ".png")
                        console.log(t)
                        return t
