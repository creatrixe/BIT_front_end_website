...
$(window).scroll(function() {
    ...
    if (scroll <= 960) {
        ...
        $('._1st_line_customer').attr('src', 'assets/img/how-it-works-red-line.png');
        $('._1st_icon_customer').attr('src', 'assets/img/ArrowRed.svg');
        $('._2nd_line_customer').attr('src', 'assets/img/how-it-works-white-line.png');
        ...
        $('._1st_line_customer').attr('src', 'assets/img/how-it-works-white-line.png');
        $('._1st_icon_customer').attr('src', 'assets/img/arrowWhite.svg');
        $('._2nd_line_customer').attr('src', 'assets/img/how-it-works-red-line.png');
...
$(window).scroll(function() {
    ...
    if (Bscroll <= 850) {
        ...
        $('._1st_line_business').attr('src', 'assets/img/how-it-works-red-line.png');
        $('._1st_icon_business').attr('src', 'assets/img/ArrowRed.svg');
        $('._2nd_line_business').attr('src', 'assets/img/how_works_black-line.png');
        ...
        $('._1st_line_business').attr('src', 'assets/img/how_works_black-line.png');
        $('._1st_icon_business').attr('src', 'assets/img/arrowBlack.svg');
        $('._2nd_line_business').attr('src', 'assets/img/how-it-works-red-line.png');
