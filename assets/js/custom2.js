$(document).ready(function () {
    ...
    leftSwiper.on('slideChange', function () {
        if(this.activeIndex < 3) {
            $('.customer_how_works').addClass('bg-gradiant-black').removeClass('bg-light-gray')
          }
        else if(this.activeIndex >= 3 && this.activeIndex < 7) {
          $('.customer_how_works').removeClass('bg-gradiant-black').addClass('bg-light-gray')
        }
        else if(this.activeIndex >= 7) {
            $('.customer_how_works').addClass('bg-bg-white').removeClass('bg-light-gray')
          }
      });
    var waiting = false;
